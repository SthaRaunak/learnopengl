...
void display()
{
    ...
    //just create every model / geometry at origin then just translate it instead of calculating pixels for each 
    glTranslatef(0.0,0.0,y_translation);
    // draw
    glBegin(GL_POLYGON);
    ...
    glVertex3f( 1, 1.0,0.0);  // top right
    glEnd();
...
void reshape(int w, int h)
{
    ...
    gluPerspective(60,1,2.0,50.0);
                   //ratio should be equal to window or might appear strecthed  out
